...
- the use of the [probegraph reusable workflow](https://github.com/Beneficial-AI-Foundation/probegraph/blob/main/.github/workflows/generate-callgraph.yml) to generate a graph
